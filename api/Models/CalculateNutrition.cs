...
{
    public static string CalculateScore(string category, double calories, double saturatedFat, double sugar, double salt, double fibre, double protein, double fruitOrVeg)
    {
        int points = 0;
    ...
    private static int CalculateEnergyPointsBeverage(double calories)
    {
    ...
    private static int CalculateEnergyPointsSolid(double calories)
    {
    ...
    private static int CalculateFruitOrVegetableContentPoints(double fruitOrVeg)
    {
    ...
    private static int CalculateFruitOrVegetableContentPointsBeverage(double fruitOrVeg)
    {
        if (fruitOrVeg <= 40) return 0;
